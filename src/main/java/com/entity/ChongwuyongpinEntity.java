...
public class ChongwuyongpinEntity<T> implements Serializable {
    ...
    @TableField(value = "miaosha_types")
    ...
    @TableField(value = "chongwuyongpin_erji_types")
