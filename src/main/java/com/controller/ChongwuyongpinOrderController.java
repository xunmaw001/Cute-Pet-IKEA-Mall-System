...
//                            chongwuyongpinOrderEntity.setChongwuyongpinOrderUuidNumber(data.get(0));                    //订单编号 要改的
...
//                            chongwuyongpinOrderEntity.setChongwuyongpinOrderCourierName(data.get(0));                    //快递公司 要改的
//                            chongwuyongpinOrderEntity.setChongwuyongpinOrderCourierNumber(data.get(0));                    //快递单号 要改的
...
//                            chongwuyongpinOrderEntity.setCreateTime(date);//时间
    ...
    */
    ...
    public R add(@RequestBody ChongwuyongpinOrderEntity chongwuyongpinOrder, HttpServletRequest request){
        ...
        if(yonghuEntity.getHuiyuandengjiTypes() !=4){
    ...
    public R add(@RequestParam Map<String, Object> params, HttpServletRequest request){
        ...
        for (Map<String, Object> map : chongwuyongpins) {
           //取值
            ...
            if(chongwuyongpinEntity.getMiaoshaTypes()==1 && chongwuyongpinEntity.getMiaoshaTime().getTime()<new Date().getTime()){//秒杀商品并且秒杀结束时间小于当前时间
            ...
            //赋值订单信息
            chongwuyongpinOrderEntity.setChongwuyongpinOrderUuidNumber(chongwuyongpinOrderUuidNumber);//订单编号
            ...
            if(chongwuyongpinOrderPaymentTypes == 1){//余额支付
                ...
                Double money = chongwuyongpinEntity.getChongwuyongpinNewMoney() * buyNumber;
                if(yonghuEntity.getYonghuNewJifen() - money <0 ){
                    ...
                    chongwuyongpinOrderEntity.setChongwuyongpinOrderTruePrice(money);//实付积分
                }
    ...
    */
    ...
    public R deliver(Integer id ,String chongwuyongpinOrderCourierNumber, String chongwuyongpinOrderCourierName , HttpServletRequest request){
        ...
        chongwuyongpinOrderEntity.setChongwuyongpinOrderCourierNumber(chongwuyongpinOrderCourierNumber);
        chongwuyongpinOrderEntity.setChongwuyongpinOrderCourierName(chongwuyongpinOrderCourierName);
