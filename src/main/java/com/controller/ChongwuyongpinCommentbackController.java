...
public class ChongwuyongpinCommentbackController {
    ...
    private static final String TABLE_NAME = "chongwuyongpinCommentback";
    ...
    */
    ...
    public R update(@RequestBody ChongwuyongpinCommentbackEntity chongwuyongpinCommentback, HttpServletRequest request) throws NoSuchFieldException, ClassNotFoundException, IllegalAccessException, InstantiationException {
        logger.debug("update方法:,,Controller:{},,chongwuyongpinCommentback:{}",this.getClass().getName(),chongwuyongpinCommentback.toString());
        ChongwuyongpinCommentbackEntity oldChongwuyongpinCommentbackEntity = chongwuyongpinCommentbackService.selectById(chongwuyongpinCommentback.getId());//查询原先数据
...
//            chongwuyongpinCommentback.setYonghuId(Integer.valueOf(String.valueOf(request.getSession().getAttribute("userId"))));
    ...
    */
    ...
    public R delete(@RequestBody Integer[] ids, HttpServletRequest request){
        ...
        List<ChongwuyongpinCommentbackEntity> oldChongwuyongpinCommentbackList =chongwuyongpinCommentbackService.selectBatchIds(Arrays.asList(ids));//要删除的数据
...
//                            chongwuyongpinCommentbackEntity.setUpdateTime(sdf.parse(data.get(0)));          //回复时间 要改的
