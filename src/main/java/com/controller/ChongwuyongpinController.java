    ...
    */
    ...
    public R save(@RequestBody ChongwuyongpinEntity chongwuyongpin, HttpServletRequest request){
        ...
        Wrapper<ChongwuyongpinEntity> queryWrapper = new EntityWrapper<ChongwuyongpinEntity>()
            ...
            .eq("miaosha_types", chongwuyongpin.getMiaoshaTypes())
            .eq("chongwuyongpin_types", chongwuyongpin.getChongwuyongpinTypes())
            .eq("chongwuyongpin_erji_types", chongwuyongpin.getChongwuyongpinErjiTypes())
...
//            return R.error(511,"永远不会进入");
        if("".equals(chongwuyongpin.getChongwuyongpinPhoto()) || "null".equals(chongwuyongpin.getChongwuyongpinPhoto())){
            ...
            chongwuyongpinService.updateAllColumnById(chongwuyongpin);//根据id更新
            return R.ok();
    }
...
//                            chongwuyongpinEntity.setMiaoshaTypes(Integer.valueOf(data.get(0)));   //是否秒杀 要改的
//                            chongwuyongpinEntity.setMiaoshaTime(sdf.parse(data.get(0)));          //秒杀到期时间 要改的
//                            chongwuyongpinEntity.setChongwuyongpinTypes(Integer.valueOf(data.get(0)));   //商品类型 要改的
//                            chongwuyongpinEntity.setChongwuyongpinErjiTypes(Integer.valueOf(data.get(0)));   //二级类型 要改的
...
//                            chongwuyongpinEntity.setChongwuyongpinNewMoney(data.get(0));                    //现价/积分 要改的
